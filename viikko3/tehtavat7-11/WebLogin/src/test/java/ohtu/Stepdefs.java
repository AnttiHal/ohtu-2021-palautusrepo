...
public class Stepdefs {
    ...
    public void userWithUsernameAndPasswordIsTriedToBeCreated(String username, String password) {
        ...
        element.click();
        registerWith(username, password);
        assertTrue(driver.getPageSource().contains("back to home"));
    ...
    @When("password {string} and password confirmation {string} do not match")
    public void passwordAndPasswordConfirmationDoesNotMatch(String password, String confirmation) {
        registerWithnonMatcingPasswords(password, confirmation);
    }
    ...
    private void registerWithnonMatcingPasswords(String password, String confirmation) {
        assertTrue(driver.getPageSource().contains("Create username and give password"));
        WebElement element = driver.findElement(By.name("username"));
        element.sendKeys("username");
        element = driver.findElement(By.name("password"));
